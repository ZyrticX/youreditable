...
// Use a different utility function name to avoid conflicts
...
export default function HeroGeometric({
  ...
  children,
  isCompact = false // New prop for compact hero on About page
}) {
  ...
  return (
    ...
    isCompact ? 'min-h-[60vh] py-16' : 'min-h-screen'}`
    }>
          ...
          className="left-[20%] md:left-[25%] top-[5%] md:top-[10%]" />
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
                <div className="text-center mx-auto py-20 max-w-4xl">
                    <motion.div
            custom={0}
