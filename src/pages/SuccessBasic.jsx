...
export default function SuccessBasicPage() {
  useEffect(() => {
    const updateUserPlan = async () => {
      try {
        await User.updateMyUserData({ plan_level: 'basic' });
        toast.success('Welcome to the Basic plan!');
      } catch (error) {
        ...
        <Card className="text-center border-amber-500/30 bg-amber-500/5">
          <CardContent className="py-12 px-8">
            <motion.div
              ...
              className="w-16 h-16 mx-auto mb-6 bg-amber-500/20 rounded-full flex items-center justify-center"
            >
            ...
            >
              ...
              <p className="text-gray-300 mb-2">
                Thank you for upgrading to Basic!
              </p>
              <p className="text-sm text-gray-400 mb-8">
                You now have access to 12 active projects and priority support.
              </p>
            </motion.div>
